...
const StorageNextCloud = StorageBase.extend({
    name: 'nextcloud',
    icon: 'server',
    enabled: true,
    uipos: 10,
    _baseURL: 'https://cloud.jombi.fr/remote.php/webdav/',
    ...
    getOpenConfig: function() {
        return {
            fields: [
                {id: 'path', title: 'openPath', desc: 'openPathDesc', type: 'text', required: true, value: 'pass.kdbx'},
...
module.exports = new StorageNextCloud();
